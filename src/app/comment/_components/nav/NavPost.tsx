    ...
    <nav className="w-11 flex-shrink-0 flex flex-col items-center text-slate-700">
      ...
      <div className="relative">
        <Image
          ...
          className="w-9"
        />
        <span className="absolute top-[6px] right-0 size-5 text-center translate-x-1/2 -translate-y-1/2 content-center bg-red-600 text-[10px] text-white border-2 border-white rounded-full">
          2
        </span>
      </div>
    </nav>
